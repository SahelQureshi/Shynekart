...
export default function works() {
  return (
    ...
    <div className="container" style={{width: "1155px",padding: "20px",backdropFilter:"blur(22px)",borderRadius:"43px",color:"white",boxShadow: "44px 43px 72px black"}}>
        <h2>How it Works</h2>
        ...
        <div className="container">
            ...
            <div className="row" style={{paddingTop:"20px"}}>
                <div className="col">
                    <h3 style={{fontWeight:"bolder",fontFamily:"Brush Script MT",fontSize:"40px"}}>01 Select Restaurant</h3>
                ...
                <div className="col">
                    <h3 style={{fontWeight:"bolder",fontFamily:"Brush Script MT",fontSize:"40px"}}>02 Select Menu</h3>
                ...
                <div className="col">
                    <h3 style={{fontWeight:"bolder",fontFamily:"Brush Script MT",fontSize:"40px"}}>03 Wait for Delivery</h3>
