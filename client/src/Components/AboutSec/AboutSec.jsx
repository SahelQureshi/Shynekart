...
export default function AboutSec() {
  return (
    <div>
      ...
      <div style={{ backgroundColor: "black", paddingTop: "2rem", height: "1572px" }}>
        <div className="container blackbody">
          ...
          <div className="row" style={{ paddingBottom: "2rem" }}>
            ...
            <div className="col" >
              ...
              <p style={{ fontFamily: "arial", color: "white", fontSize: "17px" }}>Delicious pie is a culinary delight that embodies the perfect combination of a buttery, flaky crust and a luscious, flavorful filling. Whether sweet or savory, pies have a universal appeal that spans cultures and occasions. From classic apple and cherry pies to savory options like chicken pot pie, the variations are endless. The art of making a delicious pie lies in achieving the ideal balance of textures and tastes, where the crust crumbles delicately, and the filling bursts with delectable flavors. Whether enjoyed warm with a scoop of vanilla ice cream or as a comforting savory dish, a well-made pie has the power to evoke feelings of nostalgia and satisfaction, making it a timeless and cherished treat in the world of culinary delights.</p>
            </div>
          </div>
          ...
          <div className="row" style={{ paddingBottom: "2rem" }}>
            <div className="col" >
              ...
              <p style={{ fontFamily: "arial", color: "white", fontSize: "17px" }}>A dark chocolate cake is a decadent indulgence that combines the rich, intense flavor of dark chocolate with the moist and tender texture of a perfectly baked cake. This luscious dessert is a celebration of deep cocoa notes, offering a sophisticated and satisfying experience for chocolate enthusiasts. The velvety and slightly bitter profile of dark chocolate adds a luxurious quality to the cake, creating a harmonious balance between sweetness and richness. Whether enjoyed on its own or adorned with a layer of ganache, dark chocolate cake is a timeless classic that elevates any occasion, from birthdays to special celebrations. Its sumptuous taste and velvety texture make it a perennial favorite, captivating taste buds with each indulgent bite.</p>
            </div>
      ...
      <div className="container deliverypart">
        <div className="dv">
          ...
          <p style={{
            marginLeft: "23px",
            fontSize: "24px"
          }}>After ordering the food we deliver your food within the time and we don't deliver food late.</p>
        </div>
        <div className="dv">
          ...
          <p style={{
            marginLeft: "23px",
            fontSize: "24px"
          }}>We deliver your food very fast. We deliver food by professional delivery man. We are never late.</p>
        </div>
        <div className="dv">
          ...
          <p style={{
            marginLeft: "23px",
            fontSize: "24px"
          }}>We give you many more discounts on a variety of foods. You will like it.</p>
        </div>
        <div className="dv">
          ...
          <p style={{
            marginLeft: "23px",
            fontSize: "24px"
          }}>We provide a variety of foods from spicy to sweatest</p>
        </div>
      </div>
      <div className='favorite' style={{padding:"2rem"}}>
